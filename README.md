...
> [!WARNING]
> v2.x &mdash; последняя версия использующая REST API в качестве gateway gRPC микросервисов. Разработка в этой ветке прекращена, дальше эта ветка будет получать только патчи.
