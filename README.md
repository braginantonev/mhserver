...
2. * Для запуска всего (main & subservers): `sudo ./mhserver`
   * Для запуска только основного сервера (main): `sudo ./mhserver -M`
   * Для запуска только подсерверов (subservers): `sudo ./mhserver -S`
