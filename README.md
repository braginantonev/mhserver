...
## Использование
Во время настройки вам выдадут 5 секретных ключа регистрации. Используйте их для регистрации учётных записей на сервере. 

Каждый ключ одноразовый, если понадобится больше ключей используйте скрипт 
