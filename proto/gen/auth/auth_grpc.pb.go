...
const (
	AuthService_Login_FullMethodName    = "/data.AuthService/Login"
	AuthService_Register_FullMethodName = "/data.AuthService/Register"
)
...
func (c *authServiceClient) Login(ctx context.Context, in *User, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedAuthServiceServer) Login(context.Context, *User) (*LoginResponse, error) {
